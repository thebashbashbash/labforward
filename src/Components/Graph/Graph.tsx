...
import { VictoryArea, VictoryChart, VictoryAxis, VictoryZoomContainer } from 'victory';
...
const Graph = () => {
  return (
    <Consumer>
        ...
        <VictoryChart
        domain={{y: [1, 15]}}
        containerComponent={<VictoryZoomContainer zoomDomain={{x: [0, 50], y: [0, Math.max(...appContext.state.data)]}}/>}
        >
            <VictoryAxis
              crossAxis
